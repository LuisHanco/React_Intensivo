...
<div className='contenedor_footer'>
    <div className="col_footer uno_footer">
      <img src={icon_logo} alt=""  className='logo_footer'/>
       <p><strong>Ruc:  </strong>20528032843 </p>
      <p><strong>Direccion: </strong> San Sebastian - Enaco Urb. Teneria IV Fraccion II, Cusco, Peru </p>
      <p><strong>Telefono:  </strong> 9932661357</p>
