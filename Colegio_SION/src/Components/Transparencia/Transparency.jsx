...
const documents = [
  ...
  { id: 1, title: 'Reglamento Interno (RI) 2024', url: 'https://drive.google.com/file/d/1eW1vbmlJAUuXU4q3fwi09Mk15oG3FXo1/preview', icon: '📝' },
  // 2. Plan Anual de Trabajo (PAT)
  { id: 2, title: 'Plan Anual de Trabajo (PAT)', url: 'https://drive.google.com/file/d/1QAV0spIcKxKqjgf1FzYsQFanS7zeQdii/preview', icon: '🗓️' },
  // 3. Proyecto Curricular Institucional (PCI)
  { id: 3, title: 'Proyecto Curricular Institucional (PCI)', url: 'https://drive.google.com/file/d/1CBBfCyGyIRgZkqV5wymNhwAi-jJ_UwwF/preview', icon: '🧠' },
  // 4. Proyecto Educativo Institucional (PEI)
  { id: 4, title: 'Proyecto Educativo Institucional (PEI)', url: 'https://drive.google.com/file/d/181Lj566aOCu3CLvWuDC3LCXweDQpzKrO/preview', icon: '🚀' },
];
