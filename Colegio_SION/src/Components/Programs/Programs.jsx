...
import './Programs.css'
import program_1 from '../../assets/Galeria/Programas/01-img.webp'
import program_2 from '../../assets/Galeria/Programas/02-img.webp'
import program_3 from '../../assets/Galeria/Programas/03-img.webp'
...
const programsData = [
  {
    ...
    historicalPricing: [
      { year: 2022, matricula: 160, mensualidad: 230 },
  ...
  },
  {
    ...
    historicalPricing: [
      { year: 2022, matricula: 160, mensualidad: 240 },
  ...
  },
  {
    ...
    // 🚨 NUEVOS DATOS: PRECIOS HISTÓRICOS
    historicalPricing: [
      { year: 2022, matricula: 160, mensualidad: 250 },
        ...
        <div className="program" key={program.id}>
          ...
          <div className={`program-title ${program.colorClass}`}>
            ...
            <div className='btn_box'>
                ...
                <button  className={`btn_program ${program.buttonClass}`} onClick={() => openModal(program.id)} >
                  Mas Informacion
                </button>
            </div>
          </div>
