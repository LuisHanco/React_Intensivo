...
return (
    <div className='contact'>
      <div className="contact-col">
        <h3>IEP Colegio SION </h3>
        <p>"En SION, no solo educamos mentes; formamos líderes competentes y con la conciencia social que Cusco necesita para el futuro."</p>
        <ul>
            <li><img src={mail_icon} alt="" /> direcciongeneral@colegiosion.edu.pe</li>
            <li><img src={phone_icon} alt="" /> 932661357</li>
            <li><img src={location_icon} alt="" />San Sebastian - Enaco Urb. Teneria IV Fraccion II, Cusco, Peru</li>
